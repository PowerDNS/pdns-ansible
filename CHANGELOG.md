...
- Remove the drop-in override directory when `pdns_package_state: absent`, so a later reinstall does not inherit the overrides of the previous installation ([\#275](https://github.com/PowerDNS/pdns-ansible/pull/275))
